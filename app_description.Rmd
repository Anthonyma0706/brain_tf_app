...
nodeData <- create_network(TF, data_pons$TF_target_gene_info, data_pons$unique_active_TFs_bare)$nodes
edgeData <- create_network(TF, data_pons$TF_target_gene_info, data_pons$unique_active_TFs_bare)$edges
...
plot_timeseries(TF,data_cortex$timeseries_input_meta, data_cortex$binary_activity)
