...
datatable(dplyr::filter(data_pons$TF_target_gene, TF %in% input_tf))
...
plot_UMAP(tf_number = 2,data_cortex$overall, activity_test_tf1)
...
plot_UMAP(tf_number = 1,data_pons$overall, activity_test_pon)
